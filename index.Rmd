...
At the very bottom of this page, you can see __how your name's popularity changed over the years!__
...
What if my parents chose my name solely based on it's popularity? Maybe they thought "it should be _popular_ but it shouldn't be _too_ popular but also not too unpopular, something like rank 20". Well, well, here I am, Dominik. But what if I were born as a girl, what would be my name then?
...
### If you wanna look at your own or other names and how they developed between 1984 and 2020 in Austria, just chose a name below and see!

```{r shiny-app}

# TODO: Chose name, rank or percent over time, 
...
Note that the rank as well as the proportion are per sex group.
